...
public class MusicReader {
    /**
     * A factory for producing new cs3500.music compositions, given a source of cs3500.music and a
     ...
     * </p>
     *
     * @param readable The source of data for the cs3500.music composition
                ...
                case "tempo":
                    try {
                        ...
                        throw new IllegalArgumentException(
                            "Malformed tempo line: " + scanner.nextLine());
                    }
                    break;
                case "note":
                    try {
